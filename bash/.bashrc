...
# Custom history function that requires sudo
history() {
    sudo -v && builtin history "$@"
}
...
alias listmy='bash /home/hb1240/my_scripts.sh listmy'

alias chans='~/channels.sh chans'
alias ttd='~/channels.sh ttd'
alias abn='~/channels.sh abn'
alias ntv='~/channels.sh ntv'
